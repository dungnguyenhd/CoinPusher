...
namespace EasyUI.PickerWheelUI
{
   ...
   public class PickerWheel : MonoBehaviour
   {
      ...
      [SerializeField] private GameObject wheelPieceClone;
      ...
      [SerializeField] private Spin spinButton;

      private void Start()
      {
         List<WheelPieceData> savedList = GameManager.Instance.gameData.currentWheel;

         if (savedList != null && savedList.Count > 0 && spinButton != null)
         {
            wheelPieces.Clear();
            spinButton.InitiatePieceData(savedList);
         }
      ...
      {
         wheelPieceClone = InstantiatePiece();
      ...
      public void ResetWheelPiece()
      {
         wheelCircle.transform.rotation = Quaternion.identity;
